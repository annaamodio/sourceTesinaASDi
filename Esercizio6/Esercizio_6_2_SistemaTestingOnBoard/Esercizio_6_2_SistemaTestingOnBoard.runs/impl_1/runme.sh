...
HD_PWD='C:/Users/stefa_fil71sc/Desktop/Esercizio_6_2_SistemaTestingOnBoard/Esercizio_6_2_SistemaTestingOnBoard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SistemaTesting.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SistemaTesting.tcl -notrace
