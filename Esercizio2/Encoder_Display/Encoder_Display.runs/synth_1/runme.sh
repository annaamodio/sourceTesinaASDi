...
HD_PWD='C:/esempiVIVADO/6_BCD_ENCODER_board_display1cifra/6_BCD_ENCODER_board_display1cifra.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Encoder_onBoard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Encoder_onBoard.tcl
