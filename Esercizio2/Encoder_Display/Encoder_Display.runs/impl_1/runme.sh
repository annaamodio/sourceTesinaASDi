...
HD_PWD='C:/esempiVIVADO/6_BCD_ENCODER_board_display1cifra/6_BCD_ENCODER_board_display1cifra.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Encoder_onBoard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Encoder_onBoard.tcl -notrace
