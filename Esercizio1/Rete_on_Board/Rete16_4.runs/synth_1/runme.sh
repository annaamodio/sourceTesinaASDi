...
HD_PWD='C:/Users/stefa_fil71sc/Desktop/Rete_on_Board/Rete16_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rete16_4_onboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rete16_4_onboard.tcl
