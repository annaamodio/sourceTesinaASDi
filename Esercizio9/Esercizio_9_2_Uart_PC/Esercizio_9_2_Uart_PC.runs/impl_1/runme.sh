...
HD_PWD='C:/Users/stefa_fil71sc/Desktop/Esempi/Esempi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SYS_A.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SYS_A.tcl -notrace
