...
HD_PWD='C:/Users/stefa_fil71sc/Desktop/Esempi/Esempi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SYS_A.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SYS_A.tcl
