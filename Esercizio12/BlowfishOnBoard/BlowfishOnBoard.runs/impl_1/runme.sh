...
HD_PWD='C:/Users/stefa_fil71sc/Desktop/BlowfishOnBoard/BlowfishOnBoard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BlowfishOnBoard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BlowfishOnBoard.tcl -notrace
