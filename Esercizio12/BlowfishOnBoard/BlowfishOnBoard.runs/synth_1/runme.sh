...
HD_PWD='C:/Users/stefa_fil71sc/Desktop/BlowfishOnBoard/BlowfishOnBoard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlowfishOnBoard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlowfishOnBoard.tcl
