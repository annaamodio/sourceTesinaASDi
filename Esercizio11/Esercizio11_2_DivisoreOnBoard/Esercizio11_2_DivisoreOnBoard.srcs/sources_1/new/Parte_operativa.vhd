...
architecture Structural of Parte_operativa is
    ...
    signal tmp_m : std_logic_vector( 4 downto 0) := (others => '0');
    signal tmp_q : std_logic_vector( 4 downto 0) := (others => '0');
    signal tmp_q_out : std_logic := '0';
    signal tmp_ff_out: std_logic := '0'; 
    signal tmp_ff_in: std_logic := '0';
    signal tmp_sum : std_logic_vector( 4 downto 0) := (others => '0');
    signal tmp_selector : std_logic_vector( 4 downto 0) := (others => '0');
    signal tmp_a_out : std_logic_vector( 4 downto 0) := (others => '0');
    signal tmp_cout :  std_logic := '0';
    signal tmp_mux_in : std_logic := '0';
    
begin
    reg_m : register_pp generic map(5) port map(
        CLK,
        RST,
        load_m,
        '0' & B,
    ...
    R <= tmp_a_out( 3 downto 0);
    
    selector: Selezionatore_2_1 generic map(5)
        port map(
        "00000",
        tmp_sum,
        sel,
