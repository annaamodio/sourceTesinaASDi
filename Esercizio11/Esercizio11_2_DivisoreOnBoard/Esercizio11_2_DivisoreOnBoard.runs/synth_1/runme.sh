...
HD_PWD='C:/Users/stefa_fil71sc/Desktop/Nuova cartella/Esercizio11_2_DivisoreOnBoard/Esercizio11_2_DivisoreOnBoard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DivisoreOnBoard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DivisoreOnBoard.tcl
